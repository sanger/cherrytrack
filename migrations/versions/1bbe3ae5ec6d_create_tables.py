...
Revision ID: 1bbe3ae5ec6d
Revises:
Create Date: 2021-06-09 16:07:40.370651
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("system_run_id", sa.Integer(), nullable=False, comment="the run id as used by the workcell software"),
        sa.Column(
            "method",
            sa.String(length=255, collation="utf8mb4_unicode_ci"),
            nullable=False,
    ...
    op.create_index(
        "automation_system_run_id", "automation_system_runs", ["system_run_id", "automation_system_id"], unique=True
    )
    op.create_index(
...
def downgrade():
    # TODO: need to fix these autogenerated commands as they are not working for some reason
    # I think this might help: https://alembic.sqlalchemy.org/en/latest/ops.html#alembic.operations.Operations.drop_constraint
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index("run_destination_plate_well", table_name="destination_plate_wells")
    op.drop_index(op.f("ix_destination_plate_wells_source_plate_well_id"), table_name="destination_plate_wells")
    op.drop_index(op.f("ix_destination_plate_wells_control_plate_well_id"), table_name="destination_plate_wells")
    op.drop_index(op.f("ix_destination_plate_wells_barcode"), table_name="destination_plate_wells")
    op.drop_table("destination_plate_wells")
    op.drop_index(op.f("ix_run_events_automation_system_run_id"), table_name="run_events")
    op.drop_table("run_events")
    op.drop_table("run_configurations")
    op.drop_index("control_plate_well", table_name="control_plate_wells")
    op.drop_table("control_plate_wells")
    op.drop_index("automation_system_config_key", table_name="configurations")
    op.drop_table("configurations")
    op.drop_index(op.f("ix_automation_system_runs_automation_system_id"), table_name="automation_system_runs")
    op.drop_index("automation_system_run_id", table_name="automation_system_runs")
    op.drop_table("automation_system_runs")
    op.drop_index("source_plate_well", table_name="source_plate_wells")
    op.drop_index(op.f("ix_source_plate_wells_barcode"), table_name="source_plate_wells")
